...
*   **Réalisations techniques :**
    ...
    *   Rédaction et certification du Plan d'Intervention Ultime consolidé sous [plan_intervention_ultime_alexandria_embeddings.md](file://OUTPUTS/plan_intervention_ultime_alexandria_embeddings.md) dans le sas d'autorité `/OUTPUTS/`.
    *   Élimination de torch, chromadb et sentence-transformers, refactorisation complète de [indexer_hybrid.py](file://indexer_hybrid.py) and [search_router.py](file://core/search_router.py).
    ...
    *   Création de la doctrine d'outillage éphémère llama.cpp sous [LLAMA_CPP_DOCTRINE.md](file://DataBase/Files/LLAMA.CPP%20/LLAMA_CPP_DOCTRINE.md) et du script [llama_quantize_pack.py](file://tools/llama_quantize_pack.py).
...
*   **Réalisations techniques :**
    ...
    *   Rédaction du plan d'intervention consolidé [plan_intervention_extra_reddit_commander.md](file://OUTPUTS/plan_intervention_extra_reddit_commander.md) posant l'architecture hybride (Reddit MCP local en Safe Mode strict + `@playwright/mcp` en mode assisté de formulaire et suspension en cas de challenge anti-bot).
    *   Ouverture opérationnelle du chantier SGC sous [TESLA-REDDIT-COMMANDER_v1.0_2026-07-11.md](file://Gestion-de-Chantiers/TESLA-REDDIT-COMMANDER_v1.0_2026-07-11.md) et mise à jour de l'INDEX.md.
...
### 35. Projet : tesla-video-director
*   **Objectif & Usage :**
* du Chantier
...
* ### Périmètre
* - Rédaction du fichier réglementaire [SKILL.md](file://.agents/skills/tesla-video-director/SKILL.md).
* - Description des workflows d'utilisation de l'API Interactions (Omni Flash) et de l'API Files (Gemini 1.5 Pro).
* - Documentation des interfaces d'exécution des scripts utilitaires Python locaux.
* ### Hors périmètre
* - Intégration de clés API tierces (Groq, OpenAI, Runway).
...
### 36. Projet : PROMOTION-TESLA-CURATOR-PRIME
*   **Objectif & Usage :**
* du Chantier
* Ce chantier consiste à concevoir le fichier de spécification `SKILL.md` de l'agent d'élite `tesla-curator-prime` en remplacement de l'ancien dossier `document-analyst`.
* ### Périmètre
* - Suppression physique de l'ancien répertoire [document-analyst/](file://.agents/skills/document-analyst).
* - Création du nouveau répertoire de Skill [tesla-curator-prime/](file://.agents/skills/tesla-curator-prime).
* - Rédaction du fichier réglementaire [SKILL.md](file://.agents/skills/tesla-curator-prime/SKILL.md) (en anglais strict, respectant la charte GitBook).
* - Spécification détaillée des **10 outils documentaires** indispensables (Document Parser, Citation Extractor, Evidence Builder, Contradiction Detector, Knowledge Graph Builder, Timeline Builder, Confidence Scorer, Source Classifier, Duplicate Detector, Reference Checker).
* - Définition de l'interfaçage en tant que **hub documentaire** avec nos MCP (Alexandria, Obsidian Avalon, SQLite, Context7, GitHub, Obsidian MCP, Filesystem, Browser/Playwright, Web Search).
* ### Hors périmètre
* - Développement logiciel des scripts spécifiés (délégué à **`tesla-master-code`**).
...
### 37. Projet : PROMOTION-PREMORTEM-MASTER
*   **Objectif & Usage :**
* du Chantier
* Ce chantier consiste à restructurer le Skill `premortem` pour déployer le fichier `SKILL.md` de version 2.0.
* ### Périmètre
* - Remplacement du fichier de spécification actuel `SKILL.md` sous [premortem/](file://.agents/skills/premortem).
* - Suppression de l'ancienne version temporaire `SKILL-Premortem-Master.md`.
* - Rédaction de la spécification réglementaire [SKILL.md](file://.agents/skills/premortem/SKILL.md) intégrant la division stricte des responsabilités (délégation du code à `tesla-master-code`).
* - Spécification de la persistance SQLite relationnelle (7 tables cibles : assessments, risks, assumptions, dependencies, signals, predictions, metrics) pour historiser et calibrer les stress-tests.
* - Documentation du concept de *Risk Knowledge Graph*.
* ### Hors périmètre
* - Développement des scripts d'analyse de risques ou d'AMDEC automatique (délégué à **`tesla-master-code`**).
...
### 38. Projet : INTEGRATION-AGENT-REACH
*   **Objectif & Usage :**
* du Chantier
* L'intégration a été conçue selon une architecture en entonnoir constituée d'un skill dédié, d'un script wrapper Python local pour le nettoyage sémantique, et de l'alignement des autorisations système globales et directives cognitives.
* ### Périmètre
