...
if __name__ == "__main__":
    ...
    log_path = f"/home/lord-mahonheim/.gemini/antigravity-cli/brain/{conv_id}/.system_generated/logs/transcript_full.jsonl"
    if not os.path.exists(log_path):
        log_path = f"/home/lord-mahonheim/.gemini/antigravity-cli/brain/{conv_id}/.system_generated/logs/transcript.jsonl"
