...
11. **P-AGENT-001 (Anti-Théâtre) :** Une délégation sans quittance authentique (attestation cryptographique liant l'identité à l'isolation PID/Namespace) est réputée non exécutée (Anti-Sybil).
