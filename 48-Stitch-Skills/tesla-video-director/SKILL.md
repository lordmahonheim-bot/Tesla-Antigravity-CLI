...
> Every report respects the **Règle Absolue de Livraison (SGC)**: all outputs are physically stored under `$TESLA_ROOT/OUTPUTS`.
...
- **Remotion**: [references/remotion/SKILL.md](references/remotion/SKILL.md)
